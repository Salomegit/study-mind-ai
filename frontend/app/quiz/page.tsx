...
export default function QuizPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-background/90">
      {/* Header */}
      <header className="border-b border-border bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm sticky top-0 z-50">
          ...
          {quiz.error && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-red-800 dark:text-red-200">{quiz.error}</p>
              </div>
            </motion.div>
          )}
